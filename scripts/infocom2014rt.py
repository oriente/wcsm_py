...
if __name__== '__main__':
    ...
    for seed in range(1000,1010):
        ...
        for t_start in range(traffic_start, traffic_end, int(win_size)):
            ...
            #print cc.calculate_degree()
            #print cc.calculate_eign()
            #print cc.calculate_closeness()
            #print cc.calculate_betweenness()
            #print cc.calculate_a_closeness()
            #print cc.calculate_a_betweenness()
